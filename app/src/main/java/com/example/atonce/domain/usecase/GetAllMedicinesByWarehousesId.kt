...
class GetAllMedicinesByWarehousesId(private val repo: WarehouseRepository)  {
    suspend operator fun invoke(warehouseId: Int, pageNum: Int, pageSize: Int,search: String) =
        repo.getAllMedicinesByWarehousesId(warehouseId,pageNum,pageSize,search)
}