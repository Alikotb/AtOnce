...
class WarehouseRepositoryImpl(private val remoteDataSource: RemoteDataSource) :
    ...
    override suspend fun getAllWarehousesByArea(
        ...
        return remoteDataSource.getAllWarehousesByArea(areaId, page, pageSize, search)
    ...
    override suspend fun getAllSuppliersByAreaAndMedicine(
        ...
        return remoteDataSource.getAllSuppliersByAreaAndMedicine(areaId, medicineId).map { list ->
